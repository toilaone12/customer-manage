                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" action="{{route('account.signIn')}}" method="POST">
                                @csrf
                                ...
                                <a href="{{route('account.forget')}}" class="w-100 d-flex justify-content-end mb-3 text-decoration-none">
                                    Quên mật khẩu?
                                </a>
                                <div class="mt-3">
                                ...
                                <div class="text-center mt-4 fw-light">
                                    Bạn đang không có tài khoản? <a href="{{route('account.register')}}" class="text-primary">Đăng ký</a>
                                </div>
                            </form>
                        </div>
                    </div>
